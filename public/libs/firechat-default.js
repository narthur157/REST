...
this["FirechatDefaultTemplates"]["templates/layout-full.html"] = function(obj) {obj || (obj = {});var __t, __p = '', __e = _.escape;with (obj) {__p += '<div id=\'firechat\' class=\'full\'><div id=\'firechat-header\' class=\'clearfix\'><div class=\'clearfix\'><div class=\'half dropdown\' style=\'\'><span id=\'firechat-btn-rooms\' class=\'dropdown-toggle btn full\' data-toggle="dropdown"><span class=\'icon user-chat\'></span>Chat Rooms<span class=\'caret\'></span></span><div class=\'dropdown-menu full\' role=\'menu\'><ul id=\'firechat-room-list\'></ul><div class=\'dropdown-footer aligncenter\'><button type=\'button\' class=\'btn twothird center\' id=\'firechat-btn-create-room-prompt\'>Create Room</button></div></div></div><div class=\'half dropdown\' style=\'\'><span data-event=\'firechat-user-search-btn\' class=\'btn full dropdown-toggle\' data-toggle="dropdown"><span class=\'icon user-group\'></span>Visitors<span class=\'caret\'></span></span><div class=\'dropdown-menu\' role=\'menu\'><div class=\'dropdown-header aligncenter clearfix\'><div class=\'search-wrapper\'><span class=\'icon search\'></span><input type=\'text\' data-event=\'firechat-user-search\' data-template=\'templates/user-search-list-item.html\' data-target=\'firechat-user-search\' data-controls=\'firechat-user-search-controls\' class=\'center fivesixth\'></div></div><ul id=\'firechat-user-search\'></ul><div class=\'dropdown-footer aligncenter clearfix\'><div id=\'firechat-user-search-controls\' class=\'clearfix\'><span class="quarter"></span><button type=\'button\' class=\'btn half\' data-event=\'firechat-user-search\' data-toggle=\'firechat-pagination-next\' data-template=\'templates/user-search-list-item.html\' data-target=\'firechat-user-search\' data-controls=\'firechat-user-search-controls\' disabled=disabled>Next</button></div><label class=\'center full\'><small>Use "+ Invite" button within chat rooms for regular invites.</small></label></div></div></div></div></div><div id=\'firechat-tabs\' class=\'clearfix\'><ul id=\'firechat-tab-list\' class=\'nav nav-tabs clearfix\'></ul><div id=\'firechat-tab-content\' class=\'tab-content\'></div></div><div id=\'firechat-footer\' class=\'clearfix\'></div></div>';}return __p};
...
this["FirechatDefaultTemplates"]["templates/message-context-menu.html"] = function(obj) {obj || (obj = {});var __t, __p = '', __e = _.escape, __j = Array.prototype.join;function print() { __p += __j.call(arguments, '') }with (obj) {__p += '<div data-toggle=\'firechat-contextmenu\' class=\'contextmenu\' data-message-id=\'' +__e( id ) +'\'><ul><li><span data-event=\'firechat-user-warn\'>Warn User</span></li>'; if (allowKick) { ;__p += '<li><span data-event=\'firechat-user-kick\'>Kick User</span></li>'; } ;__p += '<li><span data-event=\'firechat-user-suspend-hour\'>Suspend User (1 Hour)</span></li><li><span data-event=\'firechat-user-suspend-day\'>Suspend User (1 Day)</span></li><li><span data-event=\'firechat-message-delete\'>Delete Message</span></li></ul></div>';}return __p};

this["FirechatDefaultTemplates"]["templates/message.html"] = function(obj) {obj || (obj = {});var __t, __p = '', __e = _.escape, __j = Array.prototype.join;function print() { __p += __j.call(arguments, '') }with (obj) {__p += '<div class=\'message message-' +__e( type ) +' '; if (isSelfMessage) { ;__p += ' message-self '; } ;__p += '\' data-message-id=\'' +__e( id ) +'\' data-user-id=\'' +__e( userId ) +'\' data-user-name=\'' +__e( name ) +'\' data-class="firechat-message"><div class=\'clearfix\'><label class=\'fourfifth\'><strong class=\'name\' title=\'' +__e( name ) +'\'>' +__e( name ) +'</strong><em>(' +__e( localtime ) +')</em>:</label>'; if (!disableActions) { ;__p += '<label class=\'fifth alignright\'><span data-event=\'firechat-user-chat\' class=\'icon user-chat\' title=\'Invite to Private Chat\'>&nbsp;</span><span data-event=\'firechat-user-mute-toggle\' class=\'icon user-mute\' title=\'Mute User\'>&nbsp;</span></label>'; } ;__p += '</div><div class=\'clearfix message-content\'>' +((__t = ( message )) == null ? '' : __t) +'</div></div>';}return __p};
...
this["FirechatDefaultTemplates"]["templates/prompt.html"] = function(obj) {obj || (obj = {});var __t, __p = '', __e = _.escape;with (obj) {__p += '<div class=\'prompt hidden\'><div class=\'prompt-header\'>' +__e( title ) +'<span class=\'close right\'>X</span></div><div class=\'prompt-body clearfix\'>' +((__t = ( content )) == null ? '' : __t) +'</div><div class=\'prompt-footer\'></div></div>';}return __p};

this["FirechatDefaultTemplates"]["templates/room-list-item.html"] = function(obj) {obj || (obj = {});var __t, __p = '', __e = _.escape, __j = Array.prototype.join;function print() { __p += __j.call(arguments, '') }with (obj) {__p += '<li data-room-type=\'' +__e( type ) +'\' data-room-id=\'' +__e( id ) +'\' data-room-name=\'' +__e( name ) +'\'><span class=\'clearfix '; if (isRoomOpen) { ;__p += ' highlight '; } ;__p += '\'><span class=\'left\' title=\'' +__e( name ) +'\'>' +__e( name ) +'</span></span></li>';}return __p};

this["FirechatDefaultTemplates"]["templates/room-user-list-item.html"] = function(obj) {obj || (obj = {});var __t, __p = '', __e = _.escape, __j = Array.prototype.join;function print() { __p += __j.call(arguments, '') }with (obj) {__p += '<li data-user-id=\'' +__e( id ) +'\' data-user-name=\'' +__e( name ) +'\'><span class=\'clearfix\'><span class=\'left twothird clipped\' title=\'' +__e( name ) +'\'>' +__e( name ) +'</span>'; if (!disableActions) { ;__p += '<span data-event=\'firechat-user-mute-toggle\' class=\'icon user-mute right '; if (isMuted) { ;__p += ' red '; } ;__p += '\' title=\'Toggle User Mute\'>&nbsp;</span><span data-event=\'firechat-user-chat\' class=\'icon user-chat right\' title=\'Invite to Private Chat\'>&nbsp;</span>'; } ;__p += '</span></li>';}return __p};

this["FirechatDefaultTemplates"]["templates/room-user-search-list-item.html"] = function(obj) {obj || (obj = {});var __t, __p = '', __e = _.escape, __j = Array.prototype.join;function print() { __p += __j.call(arguments, '') }with (obj) {__p += '<li data-user-id=\'' +__e( id ) +'\' data-user-name=\'' +__e( name ) +'\'><span class=\'clearfix\'>'; if (disableActions) { ;__p += '<span class=\'left fourfifth clipped\' title=\'' +__e( name ) +'\'>' +__e( name ) +'</span>'; } else { ;__p += '<span data-event=\'firechat-user-invite\' class=\'left fourfifth clipped\' title=\'' +__e( name ) +'\'>' +__e( name ) +'</span><span data-event=\'firechat-user-invite\' class=\'icon plus right\' title=\'Invite to Room\'>+</span>'; } ;__p += '</span></li>';}return __p};

this["FirechatDefaultTemplates"]["templates/tab-content.html"] = function(obj) {obj || (obj = {});var __t, __p = '', __e = _.escape;with (obj) {__p += '<div id=\'' +__e( id ) +'\' data-room-id=\'' +__e( id ) +'\' class=\'tab-pane\'><div class=\'tab-pane-menu clearfix\'><div class=\'dropdown twofifth\'><span data-event=\'firechat-user-room-list-btn\' class=\'full btn dropdown-toggle\' data-toggle="dropdown" data-target=\'firechat-room-user-list-' +__e( id ) +'\'><span class=\'icon user-group\'></span>In Room<span class=\'caret\'></span></span><div class=\'dropdown-menu\' role=\'menu\'><ul id=\'firechat-room-user-list-' +__e( id ) +'\' class=\'full\'></ul></div></div><div class=\'dropdown twofifth\'><span data-event=\'firechat-user-search-btn\' class=\'full btn dropdown-toggle\' data-toggle="dropdown"><span class=\'icon plus\'>+</span>Invite<span class=\'caret\'></span></span><div class=\'dropdown-menu\' role=\'menu\'><div class=\'dropdown-header aligncenter clearfix\'><div class=\'search-wrapper\'><span class=\'icon search\'></span><input type=\'text\' data-event=\'firechat-user-search\' data-template=\'templates/room-user-search-list-item.html\' data-target=\'firechat-room-user-search-' +__e( id ) +'\' data-controls=\'firechat-room-user-search-controls-' +__e( id ) +'\' class=\'center fivesixth\'></div></div><ul id=\'firechat-room-user-search-' +__e( id ) +'\'></ul><div class=\'dropdown-footer aligncenter clearfix\'><div id=\'firechat-room-user-search-controls-' +__e( id ) +'\' class=\'clearfix\'><span class="quarter"></span><!--<button type=\'button\' class=\'btn third disabled\' data-event=\'firechat-user-search\' data-template=\'templates/room-user-search-list-item.html\' data-target=\'firechat-room-user-search-' +__e( id ) +'\' data-controls=\'firechat-room-user-search-controls-' +__e( id ) +'\' data-toggle=\'firechat-pagination-prev\' disabled=disabled>Prev</button>--><button type=\'button\' class=\'btn half disabled\' data-event=\'firechat-user-search\' data-template=\'templates/room-user-search-list-item.html\' data-target=\'firechat-room-user-search-' +__e( id ) +'\' data-controls=\'firechat-room-user-search-controls-' +__e( id ) +'\' data-toggle=\'firechat-pagination-next\'  disabled=disabled>Next</button></div></div></div></div><span data-event=\'firechat-close-tab\' class=\'icon close right\' style=\'15px 5px\' title=\'Leave Room\'></span></div><div class=\'clearfix\'><div id=\'firechat-messages' +__e( id ) +'\' class=\'chat\'></div></div><div class=\'clearfix\'><label>Your message:</label><textarea id=\'textarea' +__e( id ) +'\' placeholder=\'Type your message here...\'></textarea></div></div>';}return __p};

this["FirechatDefaultTemplates"]["templates/tab-menu-item.html"] = function(obj) {obj || (obj = {});var __t, __p = '', __e = _.escape;with (obj) {__p += '<li data-room-id=\'' +__e( id ) +'\'><span data-toggle=\'tab\' title=\'' +__e( name ) +'\'>' +__e( name ) +'</span></li>';}return __p};

this["FirechatDefaultTemplates"]["templates/user-search-list-item.html"] = function(obj) {obj || (obj = {});var __t, __p = '', __e = _.escape, __j = Array.prototype.join;function print() { __p += __j.call(arguments, '') }with (obj) {__p += '<li data-user-id=\'' +__e( id ) +'\' data-user-name=\'' +__e( name ) +'\'><span class=\'clearfix\'>'; if (disableActions) { ;__p += '<span class=\'left fivesixth clipped\' title=\'' +__e( name ) +'\'>' +__e( name ) +'</span>'; } else { ;__p += '<span data-event=\'firechat-user-chat\' class=\'left fivesixth clipped\' title=\'' +__e( name ) +'\'>' +__e( name ) +'</span><span data-event=\'firechat-user-chat\' class=\'icon user-chat right\' title=\'Invite to Private Chat\'>&nbsp;</span>'; } ;__p += '</span></li>';}return __p};
(function($) {
  ...
  Firechat.prototype.enterRoom = function(roomId) {
    ...
    self.getRoom(roomId, function(room) {
      ...
      if (self._user) {
        ...
        var presenceRef = self._firebase.child('room-users');
        var b = presenceRef.child(roomId);
        var c = b.child(self._userId);
        var d = c.child(self._sessionId);
